...
public class Microblog {
		...
		post_btn.addActionListener(new ActionListener() {
				...
				gl_panel_4.setHorizontalGroup(
					gl_panel_4.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_4.createSequentialGroup()
							.addComponent(text_Post, GroupLayout.PREFERRED_SIZE, 566, GroupLayout.PREFERRED_SIZE)
							.addPreferredGap(ComponentPlacement.UNRELATED)
							.addComponent(post_btn, GroupLayout.PREFERRED_SIZE, 32, Short.MAX_VALUE)
							.addContainerGap())
				);
				gl_panel_4.setVerticalGroup(
					gl_panel_4.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_4.createSequentialGroup()
							.addGap(11)
							.addComponent(post_btn, GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
						.addComponent(text_Post, GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
				);
	...
	{	panel_1 = new JPanel();
			...
			gl_panel_6.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_6.createSequentialGroup()
					.addGroup(gl_panel_6.createParallelGroup(Alignment.TRAILING)
						...
						.addComponent(panel_7, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 481, GroupLayout.PREFERRED_SIZE))
		...
		JEditorPane send_msg = new JEditorPane();
		send_msg.setDocument(new limitchar(140));
		
		GroupLayout gl_panel_8 = new GroupLayout(panel_8);
		gl_panel_8.setHorizontalGroup(
			gl_panel_8.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel_8.createSequentialGroup()
					.addComponent(send_msg, GroupLayout.PREFERRED_SIZE, 440, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
		...
		gl_panel_8.setVerticalGroup(
			gl_panel_8.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_8.createSequentialGroup()
					...
					.addGap(11))
				.addComponent(send_msg, GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
		);
